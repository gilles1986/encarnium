 ...
 *
 * @version      SVN: $Id: ValidatorManager.php 363 2012-10-20 08:11:16Z g.meyer $
 * @filesource   $HeadURL: http://svn.babiel.com/Sandbox/trunk/Projekte/PWTool/Packages/Framework/EF/ValidatorManager.php $
...
class ValidatorManager {
  ...
  private function validateForm($request) {
    $count = count($this->jsonContent['validation']);
    for($i=0; $i < $count; $i++) {
